...
<div class="card">
  ...
  <form action="{{ route('stagepieces.modifier',  $x->id) }}" method="POST">
   
   @csrf
   @method('get')

   <button type="submit" class="btn dropdown-item"><img style="float:center" src="{{asset('img/edit.png')}}" width="20" height="20" >&nbsp;&nbsp;&nbsp;Modifier</button>
</form>
  </div>
</div>
