                                        ...
                                        <img style="" src="{{asset('img/action.png')}}" width="20" height="20" >
                                            ...
                                            <div class="dropdown-menu" x-placement="right-start" style="position: absolute; transform: translate3d(111px, 0px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <form action="{{ route('stagiaires.destroy',$stagiaire->id) }}" method="POST">
                                                     <a class="btn dropdown-item" href="{{ route('stagiaires.show',$stagiaire->id) }}"><img style="" src="{{asset('img/show.png')}}" width="20" height="20" >&nbsp;&nbsp;&nbsp;Afficher</a>
                                                     <a class="btn dropdown-item" href="{{ route('stagiaires.edit',$stagiaire->id) }}"><img style="" src="{{asset('img/edit.png')}}" width="20" height="20" >&nbsp;&nbsp;&nbsp;Modifier</a>
                                                        @csrf
                                                        @method('DELETE')
