...
@endif
                    <form method="POST" class="form-prevent-multiple-submits" action="{{ route('stagiaires.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cin" type="text" class="form-control @error('cin') is-invalid @enderror" name="cin" value="" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="cin" class="col-md-4 col-form-label text-md-right">{{ __('Téléphone') }}</label>

                            <div class="col-md-6">
                                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror" name="tel" value="" required autocomplete="name" autofocus>
                            ...
                            <label for="cin" class="col-md-4 col-form-label text-md-right">{{ __('Adresse') }}</label>
